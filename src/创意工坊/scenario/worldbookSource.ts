...
export function parseScenarioSourceEntries(entries: ConfigEntry[]): ScenarioSourceBundle {
  ...
  return {
    ...
    registries: {
      世界: parseRoot(entries, '世界', z.record(z.string(), SingletonEntrySchema)),
      ...
      地图: parseRoot(entries, '地图', z.record(z.string(), MapEntrySchema)),
      地图节点: parseRoot(entries, '地图节点', z.record(z.string(), CollectionEntrySchema)),
